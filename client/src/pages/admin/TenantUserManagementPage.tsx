...
import TenantUserManagementTable from '@/components/admin/TenantUserManagementTable';
...
const TenantUserManagementPage: React.FC = () => {
  ...
  const [match, params] = useRoute('/admin/tenants/:id/users');
  ...
  useEffect(() => {
    ...
    document.title = tenantDetails?.data?.name 
      ? `${tenantDetails.data.name} Users | iREVA Admin` 
      : 'Tenant Users | iREVA Admin';
  }, [tenantDetails]);
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        ...
        <div className="flex flex-col items-start md:items-end space-y-2">
          <div className="text-sm flex items-center">
            <span className="text-muted-foreground mr-2">Organization ID:</span>
      ...
      {tenantId && <TenantUserManagementTable tenantId={tenantId} />}
    </div>
  );
};

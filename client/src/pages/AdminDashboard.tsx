          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <Link href="/admin/roi">
                    <a className="text-blue-500 text-sm hover:underline flex items-center">
                      View more
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Link href="/admin/users">
                <a className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-md transition-shadow">
              ...
              <Link href="/admin/analytics">
                <a className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-md transition-shadow">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-sm text-gray-500 mt-1">View reports</p>
                  </div>
                </a>
              </Link>
            </div>
      ...
      <div className="w-64 bg-[#553627] text-white min-h-screen">
        ...
        <nav className="mt-6">
          <Link href="/admin/dashboard">
            <a className="flex items-center px-4 py-3 bg-[#664332] text-white">
          ...
          <Link href="/admin/users">
            <a className="flex items-center px-4 py-3 text-white hover:bg-[#664332] transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
          ...
          <button onClick={handleLogout} className="w-full flex items-center px-4 py-3 text-white hover:bg-[#664332] transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">

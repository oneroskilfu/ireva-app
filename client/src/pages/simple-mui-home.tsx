// A simplified MUI homepage without dependencies on framer-motion or other hooks
...
// Simple footer with newsletter and social media
const SimpleFooter = () => {
  return (
    <Box
      component="footer"
...
// Scroll to top button (without framer-motion)
...
// Main page component
export default function SimpleMuiHome() {
  return (

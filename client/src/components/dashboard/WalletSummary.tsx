    ...
    <>
      <Card sx={{ 
        ...
        <CardContent>
          ...
          <Typography variant="h4" sx={{ fontWeight: 'bold', mb: 1 }}>{formatCurrency(balance)}</Typography>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
            <Box sx={{ textAlign: 'center' }}>
              ...
              <Typography variant="h6" color="primary.main" sx={{ fontWeight: 'medium' }}>{formatCurrency(balance)}</Typography>
            </Box>
            <Box sx={{ textAlign: 'center' }}>
              <Typography variant="body2" color="text.secondary">Pending</Typography>
              <Typography variant="h6" color="warning.main" sx={{ fontWeight: 'medium' }}>{formatCurrency(pendingAmount)}</Typography>
            </Box>
            <Box sx={{ textAlign: 'center' }}>
              <Typography variant="body2" color="text.secondary">Locked</Typography>
              <Typography variant="h6" color="text.secondary" sx={{ fontWeight: 'medium' }}>{formatCurrency(lockedAmount)}</Typography>
            </Box>
          </Box>
        ...
        <form onSubmit={handleWithdrawSubmit}>
          <DialogContent>
            <Typography variant="subtitle2" sx={{ mb: 2 }}>
              Available Balance: <span style={{ fontWeight: 'bold' }}>{formatCurrency(balance)}</span>
            </Typography>

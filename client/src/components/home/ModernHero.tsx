      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 relative z-10">
        ...
        >
          ...
          <motion.div variants={fadeIn} className="lg:col-span-6 text-white">
            ...
            >
              Invest in the Future <br />of Real Estate
            </motion.h1>
            
            <motion.div
              variants={fadeIn}
              className="mt-4 px-3 py-2 rounded-lg bg-gradient-to-r from-orange-500/20 to-yellow-500/20 inline-flex items-center border border-orange-500/30"
            >
              <svg className="w-5 h-5 text-orange-400 mr-2" viewBox="0 0 24 24" fill="currentColor">
              ...
              <span className="text-white text-sm font-semibold">Powered by Blockchain. Designed for You.</span>
            </motion.div>
            ...
            >
              Start building wealth through fractional ownership of high-yield properties with blockchain security — with as little as $50 or equivalent in crypto.
            </motion.p>

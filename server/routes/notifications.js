...
router.post('/notifications/delete', verifyToken, async (req, res) => {
  try {
    const { ids } = req.body;
...
router.get('/users/notification-preferences', verifyToken, async (req, res) => {
  try {
...
router.put('/users/notification-preferences', verifyToken, async (req, res) => {
  try {
